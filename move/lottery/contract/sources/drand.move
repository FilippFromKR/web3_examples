...
/// 'Drand' derive of-chain randomness every 30 seconds from drand genesis(1595431050) and update it on-chain.
/// So, we can estimate the deadline by calculating the future round and take the randomness for
/// determine the winner.
/// Module for verifying Drand round previous and currant signatures.
/// And deriving randomness from it.
module lottery::drand {
